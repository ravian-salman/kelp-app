...
import { Button as DefaultButton } from '@ui-kitten/components';
...
export function TextInput(props: TextInputProps) {
  ...
  return (
    <DefaultTextInput
      style={[{ backgroundColor, height: 56, borderRadius: 10, borderWidth: 0 }, style]}
      {...otherProps}
    />
  );
}
...
export function Button(props: ButtonProps) {
  ...
  return (
    <DefaultButton style={[{ borderRadius: 10, height: 56 }, style]} {...otherProps}>
      {children}
    </DefaultButton>
  );
}
